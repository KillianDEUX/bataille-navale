...
coord_t case_tabtocoord(matrice_pion_t, int);
...
coord_t aleatoire(matrice_pion_t);

// Choisis une case éloignés de toutes les autres
coord_t est_autour(matrice_pion_t);
...
coord_t choisir_case(matrice_pion_t, t_liste);
