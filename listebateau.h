...
void parcours_matrice(t_liste, coord_t *, matrice_t);//renvoie un pointeur sur un tableau des cases non disponibles pour poser les bateaux
...
void placer_bateau(t_liste, t_liste, matrice_t);//demande au joueur où il veut placer le nième bateau
