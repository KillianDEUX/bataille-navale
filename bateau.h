...
int verif_placement_bateau(bateau_t * ,dir_t, coord_t, coord_t *);/*vérifie si le bateau peut être place aux premières coordonnées selon le tableau de case_t et retourne 0 si impossible, 1 sinon */
